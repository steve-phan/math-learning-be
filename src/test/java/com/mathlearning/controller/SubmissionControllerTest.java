...
class SubmissionControllerTest {
    ...
    void uploadSubmission_ValidImage_ReturnsSubmissionResponse() throws Exception {
        ...
        when(submissionService.createSubmission(anyLong(), anyLong(), any()))
    ...
    void getHistory_ReturnsSubmissionList() throws Exception {
        ...
        when(submissionService.getUserSubmissions(anyLong())).thenReturn(submissions);
    ...
    void getSubmission_ValidId_ReturnsSubmission() throws Exception {
        when(submissionService.getSubmission(anyLong(), anyLong())).thenReturn(submissionDto);
    ...
    void getSubmission_NotFound_ReturnsBadRequest() throws Exception {
        when(submissionService.getSubmission(anyLong(), anyLong()))
